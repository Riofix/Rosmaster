...
void App_Tick(void)
{
    ...
    { // 结果输出模式
        ...
        if (result == 1)
            OLED_ShowString(3, 1, " BEAN: WHITE  ");
        else if (result == 2)
            OLED_ShowString(3, 1, " BEAN: YELLOW ");
        else if (result == 3)
            OLED_ShowString(3, 1, " BEAN: GREEN  ");
        else
            OLED_ShowString(3, 1, " BEAN: NONE   ");
    ...
    case 9:
    {
        ...
        if (val_id == BEAN_WHITE)
            OLED_ShowString(3, 1, " [WHITE BEAN] ");
        else if (val_id == BEAN_YELLOW)
            OLED_ShowString(3, 1, " [YELLOW BEAN]");
        else if (val_id == BEAN_GREEN)
            OLED_ShowString(3, 1, " [GREEN BEAN] ");
        else if (val_id == BEAN_STABLE_WAITING)
            OLED_ShowString(3, 1, "  CHECKING... ");
        else
            OLED_ShowString(3, 1, "    EMPTY     ");

...
#define POS_PULSE(pos) ((uint32_t[]){0, 8784, 17568, 27450, 70529, 58414, 6808, 36673#define CIRCLE_PULSE 104802#define CIRCLE_PULSE 104802}[(pos) - 1])

/* 环形轨道一圈脉冲数 */
// #define CIRCLE_PULSE 141303
//#define CIRCLE_PULSE 104802
#define CIRCLE_PULSE 80411
